...
System.out.println("localeFromBuilder: " +
localeFromBuilder);
...
System.out.println(String.format(locale2, "Para el trabajador %1$20s con salario %2$4.4f %n " + " o con más precisión es %2$2f y edad %3$f", nombre, salario, 56.3f));
