...
public class OperarConFechas {
	public static void main(String[] args) {
		...
		System.out.println("Fecha con dia en el año:" + date5 + " le restamos 20 días " + date5.plus(-20,DAYS));
		
		System.out.println("Fecha con dia en el año:" + date5 + " le restamos 2 MESES " + date5.plus(2,MONTHS));
	}
}